...
public class GymDTO extends UserDTO {
	...
	public GymDTO(String user_no, String user_name, String user_pw, String user_birth, String user_zipcode,
			...
			String gym_no, String gym_name, String gym_content, String gym_addr, String gym_salary, String gym_secret,
	...
	// DAO - DB
	public GymDTO(String user_name, String user_pw, String user_birth, String user_zipcode, String user_addr,
			...
			String gym_name, String gym_content, String gym_addr, String gym_salary, String gym_secret,
			String gym_images) {

		super(user_name, user_pw, user_birth, user_zipcode, user_addr, user_addrderail, user_gender, user_email,
				user_phone, user_admin, user_kakao, user_auth, user_status);
