	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link active" aria-current="page" href="univ_table_list.jsp">학생목록</a></li>
				<li class="nav-item"><a class="nav-link" href="univ_table_input_form.jsp">학생등록</a></li>
